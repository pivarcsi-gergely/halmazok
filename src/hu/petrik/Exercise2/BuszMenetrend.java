...
public class BuszMenetrend {
    ...
    public static void Run() {
        ...
        System.out.println(String.format("%d db helyen áll meg a 7-es busz.", otosBuszMegalloi.getSize()));
        System.out.println(String.format("%d db helyen áll meg az 5-ös busz.", hetesBuszMegalloi.getSize()));

        Set<String> kozosMegallok = hetesBuszMegalloi.intersect(otosBuszMegalloi);
        System.out.println("Közös megállók: " + kozosMegallok);
    }
}
